...
import { BrowserRouter, Routes, Route, Navigate } from 'react-router-dom'; // importando as confuigs para rotas
  ...
  return (
    <div className="App">
      ...
      <BrowserRouter> {/* define onde é a area do app vai trocar as paginas */}
        ...
        {/* 9 Search ou Busca - Entre a Navbar e o Router colocando um formulário de busca */}
        <SearchForm />-
